                ...
                <div class="m-l-25 m-r--38 m-lr-0-xl">
                    <div class="wrap-table-shopping-cart">
                        <table class="table-shopping-cart">
                            ...
                            @php 
                                $subtotal = ($product->price_sale != 0 ? $product->price_sale : $product->price) * $carts[$product->id];
                                $total += $subtotal;
                            @endphp
                            <tr class="table_row">
                                <td class="column-1">
                    ...
                    <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                        ...
                        <input class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" type="submit" value="Update Cart" 
