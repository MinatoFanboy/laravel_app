                        ...
                        <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                            <div class="slick-list draggable">
                                <div class="slick-track" style="opacity: 1; width: 1800px;">
                                    <div class="item-slick3 slick-slide slick-current slick-active" data-thumb="{{ $product->thumb }}" data-slick-index="0" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide10" aria-describedby="slick-slide-control10" style="width: 600px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;">
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    <div class="container">
        ...
        <!-- Slide2 -->
        <div class="wrap-slick2"><button class="arrow-slick2 prev-slick2 slick-arrow slick-disabled" aria-disabled="true"><i class="fa fa-angle-left" aria-hidden="true"></i></button>
